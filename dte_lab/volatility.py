...
(implied vol trades above realized vol on average). The multiplier is a
blunt, non-regime-aware assumption - see README.md.
"""
...
def iv_estimate(closes: Sequence[float], window: int = 20, iv_rv_multiplier: float = 1.15) -> float:
